...
export async function generateMetadata({
  ...
  const title = game?.name
    ? `Interview: ${game.name}`
    : "Interview on GamePal";
  const description = "Read this exclusive interview on GamePal!";
...
export default async function InterviewSharingPage({
  params,
}: {
  params: Promise<{ id: string }>;
}) {
